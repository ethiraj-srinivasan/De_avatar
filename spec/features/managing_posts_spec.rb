...
feature 'Managing blog posts' do
  ...
  context 'as an admin user' do
    ...
    scenario 'Posting a new blog' do
      ...
      fill_in 'post_content', :with => 'This post was made from the Admin Interface'
      fill_in 'post_author', :with => 'Ethi'
    ...
    context 'with an existing blog post' do
      background do
        @post = Post.create(:title => 'Awesome Blog Post', :content => 'Lorem ipsum dolor sit amet',:author => 'Ethi')
      end
